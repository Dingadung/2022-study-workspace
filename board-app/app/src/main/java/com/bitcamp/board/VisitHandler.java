...
public class VisitHandler {
  ...
  static void processDetail() {
    ...
    int noBoard = Prompt.inputInt("몇 번 방명록을 조회하시겠습까? ");
    for (int i = 0; i < boardCount; i++) {
    ...
    if (board == null) {
      System.out.println("해당 번호의 방명록은 존재하지 않습니다!");
  ...
  public static void processUpdate() {
    ...
    if(boardCount ==0) {
      System.out.println("현재 존재하는 방명록이 없습니다!");
      return;
    }
    int editNo = Prompt.inputInt("변경할 방명록 번호?");
